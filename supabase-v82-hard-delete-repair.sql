-- Bai Boua v82 Hard Delete + Sync Repair SQL
-- Run once in Supabase > SQL Editor > New Query > Run
-- Safe: creates/updates tables and RLS policies only. It does NOT delete existing shop data.
...
drop policy if exists "agents_insert_anon" on public.agents;
drop policy if exists "agents_update_anon" on public.agents;
drop policy if exists "agents_delete_anon" on public.agents;
